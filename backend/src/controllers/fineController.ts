...
export const getFines = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(500).json({ success: false, message: "Failed to fetch fines", error });
  }
};
...
export const getFine = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(500).json({ success: false, message: "Failed to fetch fine", error });
  }
};

// POST /api/fines — manually create a fine
export const createFine = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(500).json({ success: false, message: "Failed to create fine", error });
  }
};
...
export const payFine = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(500).json({ success: false, message: "Failed to pay fine", error });
  }
};
...
export const waiveFine = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(500).json({ success: false, message: "Failed to waive fine", error });
  }
};
...
export const getFinesSummary = async (_req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(500).json({ success: false, message: "Failed to fetch fines summary", error });
  }
};
